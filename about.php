...
<g>
	 		...
	 		<div class="menu col-7">
	 			<nav>
	 				<ul>
	 					...
	 					<li><a href="programms.php">Programmalar</a></li>
	 					<li class="top_menu_li_active"><a href="#">Biz haqimizda</a></li>
	 ...
	 <section class="page_head">
	 	<div class="section_wrapper row">
		 	<div class="page_head_text col-lg-12"><h1>Biz haqimizda</h1></div>
		 	<div class="page_head_his col-lg-12"><span>Asosiy sahifa</span> / <span>Biz haqimizda</span></div>
	 	</div>
	 </section>

<section class="about" style="opacity: 1;margin-bottom: 150px; padding: 0px;">
	<div class="section_wrapper row">
			<div class="about_content row" style="margin-top: 0px;">
				<div class="col-sm-12 col-xs-12 col-lg-12 about_content_holder">
					<h1 class="section_content_heading mb-5">Biz haqimizda malumot <br>here and text</h1>
...
<section class="services">
	<div class="section_wrapper row">
		<div class="service_item col-xs-12 col-lg-4">
			<div class="service_icon"><img src="./img/icons/cube.png"></div>
			<h5>3d modeling</h5>
			<p>Lorem ipsum dolor sit amet, consectetur adipisicing</p>
		</div>
		<div class="service_item col-xs-12 col-lg-4">
			<div class="service_icon"><img src="./img/icons/interyer2.png"></div>
			<h5>Interyer dizayn</h5>
			<p>Lorem ipsum dolor sit amet, consectetur adipisicing</p>
		</div>
		<div class="service_item col-xs-12 col-lg-4">
			<div class="service_icon"><img src="./img/icons/kourse.png"></div>
			<h5>Dasturlash kurslari</h5>
			<p>Lorem ipsum dolor sit amet, consectetur adipisicing</p>
		</div>
